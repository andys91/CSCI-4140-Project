...
--
-- Host: localhost
-- Generation Time: Jul 09, 2014 at 02:40 AM
...
--
-- Dumping data for table `e_information`
--

INSERT INTO `e_information` (`Employee_ID`, `Access_Level`, `Position`, `First_Name`, `Last_Name`, `Start_Date`) VALUES
(1, 'Level 1', 'Warden', 'Husni', 'Mubarak', '2014-07-01');
...
(113, 'Level 1', 'five years', '2019-01-01', 'Mohamed', 'Morsi', '2014-02-01');
...
ALTER TABLE `e_information`
  ADD CONSTRAINT `e_information_ibfk_1` FOREIGN KEY (`Employee_ID`) REFERENCES `employee` (`Employee_ID`) ON DELETE CASCADE;
